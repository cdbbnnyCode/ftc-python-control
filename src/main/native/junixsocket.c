...
JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocketServer__1create
...
JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocketServer__1accept
...
JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocketServer__1close
...
JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocket__1create
        (JNIEnv *env, jobject obj)
{
    return socket(AF_UNIX, SOCK_STREAM, 0);
}

JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocket__1connect
...
JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocket__1close
        (JNIEnv *env, jobject obj, jint fd)
{
    if (close(fd) < 0) return errno;
    return 0;
...
JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocket__1recv
...
JNIEXPORT jint JNICALL Java_com_ftc8813_pycontrol_websocket_UnixSocket__1send
        (JNIEnv *env, jobject obj, jint fd, jbyteArray buf, jint off, jint len)
{
    jint data_len = (*env)->GetArrayLength(env, buf);
    jbyte *data = (*env)->GetByteArrayElements(env, buf, NULL);
